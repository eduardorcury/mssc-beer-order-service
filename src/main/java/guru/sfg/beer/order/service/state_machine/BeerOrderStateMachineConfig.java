...
public class BeerOrderStateMachineConfig extends StateMachineConfigurerAdapter<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    public BeerOrderStateMachineConfig(Action<BeerOrderStatusEnum, BeerOrderEventEnum> validateOrderAction,
                                       Action<BeerOrderStatusEnum, BeerOrderEventEnum> allocateOrderAction, Action<BeerOrderStatusEnum, BeerOrderEventEnum> validationFailureAction, Action<BeerOrderStatusEnum, BeerOrderEventEnum> allocationFailureAction) {
